...
def parse_chat_message(message):
    ...
    # 2. 전달 수락 메시지
    elif any(keyword in message for keyword in ['전달드리겠습니다', '제가 전달', '전달하겠습니다', '제가 가져가겠습니다']):
        message_type = 'accept'
        # 전달자는 메시지 작성자
    ...
    try:
        ...
        if parsed['message_type'] == 'request':
            if not parsed['from_location'] or not parsed['to_location']:
                ...
                send_jandi_notification(
                    "⚠️ 위치 정보 누락",
                    f"운송 요청에 위치 정보가 누락되었습니다!\n\n📍 **올바른 형식:**\n`출발지 → 도착지 물품명 요청`\n\n**예시:**\n• 평촌 → 판교 센서 이송 부탁드립니다\n• 평촌 > 광주 센서 이송 부탁드립니다\n• 광주에서 평촌으로 노트북 전달 요청\n• 판교 --> 광주 ML-U 센서 이동하시는 분\n\n🔍 **사용 가능한 위치:**\n• 평촌 (제조혁신센터)\n• 판교 (R&D 1,2센터)\n• 광주 (광주본사, 광주R&D)\n\n➡️ **화살표:** → > --> 모두 사용 가능",
                    "#e74c3c"
                )
        ...
        # 3. 완료 메시지
            ...
            if any(keyword in message for keyword in ['운송', '이송', '전달', '배송']):
                send_jandi_notification(
                    "❓ 양식 안내",
                    "올바른 메시지 형식을 사용해주세요!\n\n📝 **올바른 양식:**\n\n1️⃣ **운송 요청**\n• 평촌 → 판교 센서 이송 부탁드립니다\n• 평촌 > 광주 센서 이송 부탁드립니다\n• 광주에서 평촌으로 노트북 전달 요청드립니다\n• 판교 --> 광주 ML-U 센서 이동하시는 분\n\n2️⃣ **전달 수락 (댓글로)**\n• 제가 전달드리겠습니다\n• 제가 가져가겠습니다\n\n3️⃣ **완료 확인**\n• 잘 받았습니다\n• 수령했습니다\n\n🔍 **인식 가능한 위치:**\n• 평촌 (제조혁신센터) • 판교 (R&D 1,2센터) • 광주 (광주본사, 광주R&D)\n\n➡️ **화살표:** → > --> 모두 사용 가능\n📦 **물품 예시:** 센서, 노트북, 박스, ML-U, SL-U",
                    "#f39c12"
                )
